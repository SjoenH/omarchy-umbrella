...
// MET nowcast/2.0 radar coverage: the Nordics + Baltics mosaic. Outside this
// bounding box there is no radar source at all — the hourly forecast decides.
function inNowcastRegion(lat, lon) {
